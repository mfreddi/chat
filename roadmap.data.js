      ...
      cards: [
        {
          ...
          tag: 'later',
          body: 'Любое событие на любой подключённой площадке (фоллоу, сабка, донат, награда, рейд — Twitch / VK Play / Kick / YouTube) сможет запускать любое действие: алерт, смену сцены в OBS, озвучку, ответ бота в чат. Без отдельного стороннего приложения рядом.'
        },
        {
